...
<html>
  <head>
    ...
    <title>My JSP 'createWorkRecord.jsp' starting page</title>
  ...
  <body>
    ...
    <div id="contentArea">
    	<div id="buttons">
    		<ul>
    			<li><img alt="" src="/oa/images/add.png"><span>添加</span></li>
    			<li><img alt="" src="/oa/images/edit.png"><span>修改</span></li>
